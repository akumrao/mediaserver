 ...
 */
   ...
   */
    ...
    protected:
        LiveConnectionContext& ctx; ///< LiveConnectionContext identifying the stream source (address), it's destination (slot and target liveFrame), etc.

        // internal liveFrame chain.. if we'd like to modify the frames before they are passed to the API user
        ...
        // TimestampFrameFilter2   timestampfilter; ///< Internal liveFrame: correct timestamp
        // SlotFrameFilter         inputfilter;     ///< Internal liveFrame: set slot number
