...
var setupDataChannel = function (dataChannel) {
  ...
  dataChannel.onmessage = function (event) {
    ...
    receiveProgress += event.data.byteLength;
    var currentThroughput = (receiveProgress / (performance.now() - sendStartTime))/1000;
    console.log('Current Throughput is:', currentThroughput, 'Mbytes/sec');

    document.getElementById('lbltipAddedComment').innerHTML = currentThroughput;
