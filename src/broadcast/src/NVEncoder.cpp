...
NVEncoder::NVEncoder(en_EncType encType):VideoEncoder(encType),NV_Encoder(encType)
{
...
NVEncoder::~NVEncoder()
{
 ...
 // int32_t NVEncoder::InitEncode(const webrtc::VideoCodec* CodecSetings, int32_t NumberOfCores, size_t MaxPayloadSize)
 // {

 //       return ::InitEncode(const webrtc::VideoCodec* CodecSetings, int32_t NumberOfCores, size_t MaxPayloadSize)
 // }
...
int32_t NVEncoder::Encode(const webrtc::VideoFrame& input_frame, const std::vector<webrtc::VideoFrameType>* frame_types)
{
    //SInfo << "Encode";
...
void NVEncoder::write_frame(AVPacket* enc_pkt)
{
