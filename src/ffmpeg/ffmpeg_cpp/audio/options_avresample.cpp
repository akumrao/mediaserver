...
static const AVOption avresample_options[] = {
   { "in_channel_layout",      "Input Channel Layout",     OFFSET(in_channel_layout),      AV_OPT_TYPE_INT64,  { .i64 = 0              }, INT_MIN, INT_MAX,              PARAM },
    ...
    { "out_channel_layout",     "Output Channel Layout",    OFFSET(out_channel_layout),     AV_OPT_TYPE_INT64,  { .i64 = 0              }, INT_MIN, INT_MAX,              PARAM },
...
AVAudioResampleContext *avresample_alloc_context(void)
{
    ...
    avr = (AVAudioResampleContext*)av_mallocz(sizeof(*avr));
    if (!avr)
        return NULL;
