...
static const uint8_t tc0_table[52*3][4] = {
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    ...
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 },
    {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 0 }, {(uint8_t)-1, 0, 0, 1 },
    {(uint8_t)-1, 0, 0, 1 }, {(uint8_t)-1, 0, 0, 1 }, {(uint8_t)-1, 0, 0, 1 }, {(uint8_t)-1, 0, 1, 1 }, {(uint8_t)-1, 0, 1, 1 }, {(uint8_t)-1, 1, 1, 1 },
    {(uint8_t)-1, 1, 1, 1 }, {(uint8_t)-1, 1, 1, 1 }, {(uint8_t)-1, 1, 1, 1 }, {(uint8_t)-1, 1, 1, 2 }, {(uint8_t)-1, 1, 1, 2 }, {(uint8_t)-1, 1, 1, 2 },
    {(uint8_t)-1, 1, 1, 2 }, {(uint8_t)-1, 1, 2, 3 }, {(uint8_t)-1, 1, 2, 3 }, {(uint8_t)-1, 2, 2, 3 }, {(uint8_t)-1, 2, 2, 4 }, {(uint8_t)-1, 2, 3, 4 },
    {(uint8_t)-1, 2, 3, 4 }, {(uint8_t)-1, 3, 3, 5 }, {(uint8_t)-1, 3, 4, 6 }, {(uint8_t)-1, 3, 4, 6 }, {(uint8_t)-1, 4, 5, 7 }, {(uint8_t)-1, 4, 5, 8 },
    {(uint8_t)-1, 4, 6, 9 }, {(uint8_t)-1, 5, 7,10 }, {(uint8_t)-1, 6, 8,11 }, {(uint8_t)-1, 6, 8,13 }, {(uint8_t)-1, 7,10,14 }, {(uint8_t)-1, 8,11,16 },
    {(uint8_t)-1, 9,12,18 }, {(uint8_t)-1,10,13,20 }, {(uint8_t)-1,11,15,23 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    ...
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
    {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 }, {(uint8_t)-1,13,17,25 },
};
