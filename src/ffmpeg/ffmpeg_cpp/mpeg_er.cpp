...
{
    MpegEncContext *s = (MpegEncContext *)opaque;
...
int ff_mpeg_er_init(MpegEncContext *s)
{
    ...
    er->er_temp_buffer     = ( uint8_t *)av_malloc(s->mb_height * s->mb_stride * (4*sizeof(int) + 1));
    er->error_status_table = (uint8_t *)av_mallocz(mb_array_size);
