                      ...
                      AVDictionary **metadata)
{
    ...
    av_dict_set(metadata, key, (const char*)text, 0);
                      ...
                      int isv34)
{
    ...
    new_extra = (ID3v2ExtraMeta*)av_mallocz(sizeof(*new_extra));
    apic      = (ID3v2ExtraMetaAPIC*)av_mallocz(sizeof(*apic));
    if (!new_extra || !apic)
        goto fail;
                      ...
                      const char *tag, ID3v2ExtraMeta **extra_meta, int isv34)
{
    ...
    meta = (ID3v2ExtraMeta *)av_mallocz(sizeof(*meta));
    priv = (ID3v2ExtraMetaPRIV *)av_mallocz(sizeof(*priv));
    ...
    priv->data = (uint8_t*)av_malloc(taglen);
    if (!priv->data)
        goto fail;
...
int ff_id3v2_parse_apic(AVFormatContext *s, ID3v2ExtraMeta **extra_meta)
{
    ...
    for (cur = *extra_meta; cur; cur = cur->next) {
        ...
        if (strcmp(cur->tag, "APIC"))
            continue;
        apic = (ID3v2ExtraMetaAPIC*)cur->data;
