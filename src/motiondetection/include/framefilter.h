...
class FileFrameFilter : public FrameFilter { 

public:                                                                                
    FileFrameFilter(const char *name, std::string &cam, FrameFilter *next = NULL); 
     ~FileFrameFilter();
 ...
 * @ingroup filters_tag
 */
class H264DumpFrameFilter : public FrameFilter { 

public:                                                                    
    H264DumpFrameFilter(const char *name,  std::string &cam,  FrameFilter *next = NULL); 
