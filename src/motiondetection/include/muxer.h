...
public:                                                              //
    MuxFrameFilter(const char* name, std::string & cam, FrameFilter *next = NULL,  FrameFilter *txt=NULL, FrameFilter *muxer = NULL);      //
...
public:                                                                     
    FragMP4MuxFrameFilter(const char* name, std::string & cam, FrameFilter *next = NULL, FrameFilter *txt=NULL);      
